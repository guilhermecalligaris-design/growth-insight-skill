...
**Tese:** Demand generation move o foco de captura de lead de curto prazo para **posicionamento** junto aos 95% que ainda não estão comprando.
**Framework — Regra 95-5 (John Dawes, 2021):** só **5%** do mercado está em modo de compra agora; **95%** está fora-de-mercado mas é a oportunidade futura → publicidade deve construir **disponibilidade mental**, não só capturar quem já quer.
**Matriz Brand Awareness × Demand Gen × Lead Gen:** *Awareness* (longo prazo, reconhecimento, time de marca) · *Demand Gen* (médio prazo, interesse+posicionamento, time de growth) · *Lead Gen* (imediato, captura de contato, sales ops).
**Táticas:** reposicionar estratégia de gated content (gating seletivo: o que serve autoridade vs captura?); transformar webinar/report/pesquisa de "fábrica de lead" em "motor de reputação"; alocação dual-track (lead gen p/ receita imediata + verba p/ cultivar os 95% com conteúdo/SEO/thought leadership); mensagem segmentada por in-market (5%) vs out-of-market (95%).
**Exemplos:** ebook gated (lead gen clássico) vs report de acesso aberto (demand gen, constrói autoridade e alcança os 95%).
**Anti-padrões:** abandonar lead gen inteiro (ignora a necessidade real de receita); confundir terminologia nova com estratégia nova; forçar todo conteúdo atrás de form; tratar demand gen e lead capture como oposição em vez de complementares.
**Takeaway:** não é revolução — é reenquadramento que legitima o marketing equilibrado: resolver a receita de hoje (lead gen) **enquanto** posiciona pros clientes de amanhã (demand gen).

## Contextual Outbound (o outbound que não queima a marca)
B2B/outbound · [fonte](https://growthinsight.com.br/p/contextual-outbound) · Felipe Collins *(premium 👑 — mecânica detalhada é paga; lacuna)*

**Tese:** O outbound tradicional satura o mercado e danifica a marca; o **Contextual Outbound** preserva reputação enquanto converte, via segmentação profunda.
**Framework (parte visível):** 1) Segmentação profunda (não lista spray-and-pray) · 2) Mensagem personalizada ancorada no contexto do prospect · 3) Conteúdo alinhado entre canais · 4) Abordagem consciente da marca (prioriza reputação). *(mecânica completa é premium.)*
...
## Confiança — o multiplicador invisível (Speed of Trust aplicado ao marketing)
B2B/confiança · [parte 1](https://growthinsight.com.br/p/confianca) · [13 comportamentos](https://growthinsight.com.br/p/confianca-13-comportamentos-1) · [parte 3](https://growthinsight.com.br/p/confianca-parte-3) · Felipe Collins

**Tese:** Confiança é multiplicador invisível do resultado — vira "taxa" (freia) ou "dividendo" (potencializa): **Resultado = (Estratégia × Execução) × Confiança**.
**Frameworks (Covey / Speed of Trust):** *4 núcleos de credibilidade* — Integridade · Intenção · Capacidade · Resultados. *5 ondas* — Self → Relacionamento → Organizacional → Mercado → Sociedade. *13 comportamentos* — caráter (parte 1): papo reto, demonstre respeito, crie transparência, corrija erros, mostre lealdade, entregue resultados; competência (parte 3): melhore e aprenda, confronte a realidade, esclareça expectativas, assuma seus BOs (accountability), escuta ativa, mantenha compromissos, estenda confiança (delegue com autoridade real).
**Táticas:** cumprir promessa de forma sistemática; comunicar a motivação comercial com transparência; publicar KPI mesmo ruim; ser específico em prazo ("2-3 dias úteis SP" > "rápido"); número real em copy ("2.347 clientes" > "milhares"); cancelamento tão fácil quanto a assinatura; devolução generosa sem interrogatório; delegar com limite de autonomia (Ritz-Carlton US$2k/hóspede/dia).
**Exemplos:** Patagonia (as 5 ondas: fundador ativo → garantia vitalícia/"não compre" → sabático em ONG → Footprint Chronicles → doação de US$3bi ao clima) · Tylenol/J&J (recall de 31M frascos → recuperou 70% do share em 5 meses) · Avis "We Try Harder" · Warby Parker (custo transparente US$95 vs US$230) · Old Spice (+60%) · LEGO Ideas (turnaround de US$800M de dívida).
**Anti-padrões:** comunicação burocrática redundante (trust tax); microgerenciamento (sinaliza desconfiança); promessa não cumprida (erode rápido); altruísmo fingido com agenda oculta; escassez falsa ("só 50" todo dia); dark pattern (cancelamento difícil, checkbox pré-marcado); "confio mas não delego".
**Takeaway:** confiança leva anos pra construir e segundos pra destruir — **consistência de entrega + transparência de intenção** é o ativo composto. (Base dos 4 R's e da reputação B2B acima.)
